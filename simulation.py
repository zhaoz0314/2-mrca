...
# set parameters
# with the default parameters, the estimated run time is 15 hours
...
combined_parameters= [0, 1/4, 1/2, 1, 2, 4, 8, 16, 20, 24, 28, 32] # sequence_length*recombination_rate*population_size
